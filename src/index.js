document.addEventListener("DOMContentLoaded", () => {
  ...
  const launchTimer = () => {
    timer = setInterval(() => {
      quiz.timeRemaining--;
      timeRemainingContainer.innerText = convertRemainingTimeToStr(
        quiz.timeRemaining
      );
      const remainingTimeInPercentage =
        (quiz.timeRemaining / quiz.timeLimit) * 100;
  ...
  function nextButtonHandler() {
    ...
    selectedAnswer = choiceContainer.querySelector("input:checked");
